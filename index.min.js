!(function(e, t) {
  ...
  function $(e) {
    return Array.isArray(e) && 2 === e.length && e.every(I) && e[0] <= e[1];
  }
  function j(e) {
    var t = new Date(e);
    if (I(t)) return t;
        ...
        methods: {
          ...
          getCellTitle: function(e) {
            var t = this.titleFormat,
              n = N(this.calendarYear, this.calendarMonth, e);
            return this.formatDate(n, t);
          },
          getWeekNumber: function(e) {
            var t = N(this.calendarYear, this.calendarMonth, e);
    ...
    ye = Q(
                    ...
                    t._l(t.dateHeader, function(e) {
                      return n(
                        'button',
                        {
                          ...
                          on: {
                            click: function(n) {
                              return t.handelPanelChange(e.panel);
                            },
                          },
                        },
                        [t._v('\n          ' + t._s(e.label) + '\n        ')]
      ...
      void 0,
      {
        ...
        data: function() {
          ...
          return { panel: -1 !== t ? e[t] : 'date', innerCalendar: null };
        },
        computed: {
          innerValue: function() {
        ...
        methods: {
          ...
          getCellDate: function(e, t) {
            return 'year' === t
              ? N(e, 0)
              : 'month' === t
              ? N(this.calendarYear, e)
              : N(this.calendarYear, this.calendarMonth, e);
          },
  ...
  var _e = ['attrs', 'props', 'domProps'],
    ...
    Ie = { default: ye, time: ke, datetime: Pe },
    $e = { default: ge, time: Me, datetime: Ne },
    je = Q(
      {
        render: function() {
          var e,
